...
var ASM_CONSTS = {
  6376800: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 6376861: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 6376925: function() {return Module.webglContextAttributes.powerPreference;},  
 6376983: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 6377038: function($0) {performance.now = function() { return $0; };},  
 6377086: function($0) {performance.now = function() { return $0; };},  
 6377134: function() {performance.now = Module['emscripten_get_now_backup'];}
};
                      ...
                      navigator.mediaDevices.getUserMedia({
                          ...
                          .then(function(stream) {
                              ...
                              worklet.port.onmessage = function(e) {
                                  ...
                                  (function(a1, a2, a3) {  dynCall_viii.apply(null, [dataCallback, a1, a2, a3]); })(handle, ptr, b.length);
                                  _free(ptr);
                              }
                              audioContext.resume();
                              ...
                              (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [createCallback, a1, a2, a3, a4]); })(handle, 0, audioContext.sampleRate, 1);
                          })
                          .catch(function(err) {
                              ...
                              (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [createCallback, a1, a2, a3, a4]); })(handle, 2, 0, 0);
                          });
                  },
                  function(err) {
                      ...
                      if (Module.PhotonVoice_WebAudioMicIn_InputsStopped) {
                       ...
                       (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [createCallback, a1, a2, a3, a4]); })(handle, 3, 0, 0);
                  }
              );
  
          } else {
              console.error('[PV] PhotonVoice_WebAudioMicIn_Start error: ' + 'getUserMedia not supported on your browser!');
              (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [createCallback, a1, a2, a3, a4]); })(handle, 1, 0, 0);
          }
      }
          ...
          if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia && navigator.mediaDevices.enumerateDevices) {
              navigator.mediaDevices.getUserMedia({ audio: kindStr.startsWith("audio"), video: kindStr.startsWith("video") }).then(function(stream) {
                  navigator.mediaDevices.enumerateDevices().then(devices => {
                      ...
                      (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [resultCallback, a1, a2, a3, a4]); })(requestId, 0, ptr, res.length);
                  ...
                  .catch(function(err) {
                      ...
                      (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [resultCallback, a1, a2, a3, a4]); })(requestId, 1, 0, 0);
                  });
              })
              .catch(function(err) {
                  console.error('[PV] PhotonVoice_WebRTC_EnumerateDevices enumerateDevices permission error: ' + err);
                  (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [resultCallback, a1, a2, a3, a4]); })(requestId, 2, 0, 0);
              });
          } else {
              console.error('[PV] PhotonVoice_WebRTC_EnumerateDevices error: ' + 'enumerateDevices not supported on your browser!');
              (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [resultCallback, a1, a2, a3, a4]); })(requestId, 3, 0, 0);
          }
      }
...
/** @type {function(...*):?} */
var dynCall_viiiiiiiiifiiiii = Module["dynCall_viiiiiiiiifiiiii"] = createExportWrapper("dynCall_viiiiiiiiifiiiii");
...
/** @type {function(...*):?} */
var dynCall_iiddddddi = Module["dynCall_iiddddddi"] = createExportWrapper("dynCall_iiddddddi");
...
/** @type {function(...*):?} */
var dynCall_iijidddi = Module["dynCall_iijidddi"] = createExportWrapper("dynCall_iijidddi");

/** @type {function(...*):?} */
var dynCall_iiiijidddi = Module["dynCall_iiiijidddi"] = createExportWrapper("dynCall_iiiijidddi");
